...
class SharedPreferenceManagerClassGenerator {
  static Future<void> generate(String projectName) async {
    print("🛠️ Generating shared preference manager...");

    Directory('$projectName/lib/core/services').createSync(recursive: true);
    final sharedPreferenceManagerDirectory = File('$projectName/lib/core/services/shared_preference_manager.dart');

    sharedPreferenceManagerDirectory.writeAsStringSync("""
